...
target_jobs = [
'443', '179', '290', '430', '83', '475', '141', '355', '441', '415', '94', '276', '356', '164', '407', '196', '294', '197', '277', '201', '488', '495', '330', '339', '126', '395', '205', '425', '90', '178', '418', '366', '129', '467', '278', '332', '238', '342', '76', '496', '244', '280', '214', '229', '62', '271', '107', '413', '144', '500', '88', '424', '352', '105', '241', '208', '459', '74', '134', '146', '365', '487', '84', '326', '383', '204', '191', '185', '169', '249', '192', '143', '243', '120', '198', '224', '165', '417', '397', '72', '163', '194', '79', '98', '312', '320', '376', '287'
]

# Agents 9-30 (since 1-8 are killed)
available_agents = set(str(i) for i in range(16, 31))
